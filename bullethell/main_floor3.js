...
counter -= 1;
           ...
           if (this.age % 12 == 0 ){return;
            ...
            kome = komes.pop();
            kome.centerX = this.centerX+ (70* Math.cos(((angle2-90)) * (Math.PI / 180))) ;
            kome.centerY = this.centerY+ (50* Math.sin((angle2)/2 * (Math.PI / 180)));;
                            // radian = 0;
                            // radian = Math.atan2(tama.centerY - playerEntityGroup.y, tama.centerX - playerEntityGroup.x);
                            // angle = radian / (Math.PI / 180) + 180;
                            // 距離と角度から座標 
                            ...
                            kome.moveX = 5 * Math.cos(angle * (Math.PI / 180));
                            kome.moveY = 5 * Math.sin(angle * (Math.PI / 180));
                           ...
                           if (isOutside(this)) { 
                                ...
                                aokome = aokomes.pop();
                                aokome.centerX =this.centerX+(70*Math.sin((angle2)/2 * (Math.PI / 180))) ;
                                aokome.centerY = this.centerY+ (50* Math.cos(((angle2-90))* (Math.PI / 180)) );
                                    // radian = 0;
                                    // radian = Math.atan2(tama.centerY - playerEntityGroup.y, tama.centerX - playerEntityGroup.x);
                                    // angle = radian / (Math.PI / 180) + 180;
                                    angle = (360/c)*i-rad*(360/62)-rad4;
                                    ...
                                    aokome.moveX = 5 * Math.cos(angle * (Math.PI / 180));
                                    aokome.moveY = 5   * Math.sin(angle * (Math.PI / 180));
