...
bombs -= 1;
  ...
  core.keybind("49","one");
    ...
    core.keybind("53","five");
    core.keybind("54","six");
    core.keybind("55","seven");
  var enemyx=330;
var count = 0;
var patern = 0;
var counter = 0;
...
//    floor6Start();
                       ...
                       if(core.input.one==true){
                        floor1Start();
                       } else if(core.input.two==true){
                        floor2Start();
                       } else if(core.input.three==true){
                        floor3Start();
                       } else if(core.input.four==true){
                        floor4Start();
                       } else if(core.input.five==true){
                        floor5Start();
                       } else if(core.input.six==true){
                        floor6Start();
                       } 
