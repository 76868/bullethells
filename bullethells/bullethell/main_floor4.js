...
Random = random(0,60);
                            for (i = a; i <= b; i++) {
                            if (tamakawa.length <= 10 || enemy2.centerY>300||komes.length<=10) return;
                            if(delay<=deal){
                        //    tamakawa= objectpool2.pop();
            ...
            kome = komes.pop();
            kome.centerX = this.centerX+ (125* Math.cos(((angle2)) * (Math.PI / 180)))+Random*i ;
            kome.centerY = this.centerY;
                            // radian = 0;
                            // radian = Math.atan2(tama.centerY - playerEntityGroup.y, tama.centerX - playerEntityGroup.x);
                            // angle = radian / (Math.PI / 180) + 180;
                            ...
                            kome.moveX = 4 * Math.cos(angle * (Math.PI / 180));
                            kome.moveY = 4 * Math.sin(angle * (Math.PI / 180));
