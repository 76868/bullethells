...
// Random = random(30,40);
            ...
            middletama.centerX = this.centerX+ (Math.abs(angle2/3)* Math.cos(((angle2 + 45*r)) * (Math.PI / 180)));
            middletama.centerY = this.centerY+ (Math.abs(angle2/3)* Math.sin(((angle2+ 45*r)) * (Math.PI / 180)));
                            // radian = 0;
                            // radian = Math.atan2(tama.centerY - playerEntityGroup.y, tama.centerX - playerEntityGroup.x);
                            ...
                            // tamakawa.moveX = 7 * Math.cos(angle * (Math.PI / 180));
                            // tamakawa.moveY = 7  * Math.sin(angle * (Math.PI / 180));
                            middletama.moveX = 6 * Math.cos(angle * (Math.PI / 180));
                            middletama.moveY = 6 * Math.sin(angle * (Math.PI / 180));
